...
const keySignatures = [
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 7,
      accidentalSemitonesFromC: circleOfFifths.find((hs) =>
        hs.rel.sharp.inKeys.includes(1),
      ).id,
      events: ["C#", "D#", "E#", "F#", "G#", "A#", "B#"],
      major: {
        name: "C# Major",
    ...
    flat: {
      accidentalsCount: 5,
      accidentalSemitonesFromC: circleOfFifths
        .reverse()
        .find((hs) => hs.rel.flat.inKeys.includes(1)).id,
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 2,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.sharp.inKeys.includes(2))
        .map((hs) => hs.id),
  ...
  },
  {
    ...
    flat: {
      accidentalsCount: 3,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.flat.inKeys.includes(3))
        .map((hs) => hs.id)
        .reverse(),
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 4,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.sharp.inKeys.includes(4))
        .map((hs) => hs.id),
  ...
  },
  {
    ...
    flat: {
      accidentalsCount: 1,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.flat.inKeys.includes(5))
        .map((hs) => hs.id)
        .reverse(),
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 6,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.sharp.inKeys.includes(6))
        .map((hs) => hs.id),
    ...
    flat: {
      accidentalsCount: 6,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.flat.inKeys.includes(6))
        .map((hs) => hs.id)
        .reverse(),
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 1,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.sharp.inKeys.includes(7))
        .map((hs) => hs.id),
  ...
  },
  {
    ...
    flat: {
      accidentalsCount: 4,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.flat.inKeys.includes(8))
        .map((hs) => hs.id)
        .reverse(),
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 3,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.sharp.inKeys.includes(9))
        .map((hs) => hs.id),
  ...
  },
  {
    ...
    flat: {
      accidentalsCount: 2,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.flat.inKeys.includes(10))
        .map((hs) => hs.id)
        .reverse(),
  ...
  },
  {
    ...
    sharp: {
      accidentalsCount: 5,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.sharp.inKeys.includes(11))
        .map((hs) => hs.id),
    ...
    flat: {
      accidentalsCount: 7,
      accidentalSemitonesFromC: circleOfFifths
        .filter((hs) => hs.rel.flat.inKeys.includes(11))
        .map((hs) => hs.id)
        .reverse(),
